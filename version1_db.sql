...
-- Table `kioskdb`.`Faq`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kioskdb`.`Faq` (
...
-- -----------------------------------------------------
-- Table `kioskdb`.`Statistics`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kioskdb`.`Statistic` (
  `id` INT UNSIGNED NOT NULL,
  `timestamp` DATETIME NULL,
  `Faq_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`, `Faq_id`),
  INDEX `fk_Statistics_Faq_idx` (`Faq_id` ASC),
  CONSTRAINT `fk_Statistics_Faq`
    FOREIGN KEY (`Faq_id`)
    REFERENCES `kioskdb`.`Faq` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
INSERT INTO `Faq` ( id, question, answer, counter )
